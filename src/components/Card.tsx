...
export default function Card() {
  ...
  const handleDownloadCV = () => {
    ...
    link.href = cv;
    link.download = "OlhaKucheruk_CV.pdf";
        ...
        <div className="card-title title-container">
          <div className="about-left">
            ...
            <p className="description">
              ...
              user-friendly applications. Fluent in three languages, I bring
              strong communication and a global perspective to every project.
              With a sharp eye for design and solid technical skills, I thrive
              in collaborative environments and am eager to drive innovation in
              impactful projects.
            </p>
            <div className="flex">
              <button
