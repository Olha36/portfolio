        ...
        <div className='info-container'>
          ...
          <div className='soft-skills'>
            ...
            <ul>
              ...
              <li>
                <span className='bold'>Continuous Learning: </span> Enthusiastic about personal and professional growth,
                with a commitment to staying updated on the latest technologies and industry trends.
              </li>
              <li>
